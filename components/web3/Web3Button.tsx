            ...
            <span className="text-xs leading-4 font-medium text-[#7f7f7f]">
              ...
              <span className="text-xs leading-4 font-medium text-blue-600">
                <Link href={"https://ethereum.org/wallets/"}>
                  <a
                    className="text-baseline whitespace-nowrap text-blue-600 opacity-80 hover:opacity-100 focus:opacity-100"
                    target="_blank"
                  >
        ...
        <DialogContent>
          <div className="flex flex-col gap-3 border border-[#20223199] rounded p-4">
            ...
            <div className="flex items-center gap-2 space-x-3">
              <Link
                href={
                  "https://etherscan.io/address/0xC12F5cB5F3b7C7E5e0f632DadA6E029d20c5BE0d"
                }
              >
                <a
                  className="text-baseline whitespace-nowrap text-blue-600 opacity-80 hover:opacity-100 focus:opacity-100 space-x-1 flex items-center justify-center"
                  target="_blank"
                >
  ...
  return (
    <>
      {active ? (
        ...
        <ConnectButton
          title={width < 680 ? "Connect" : "Connect Wallet"}
          openConnectDlg={openConnectDlg}
        />
      )}
    </>
  );
