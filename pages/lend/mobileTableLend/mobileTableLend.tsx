    ...
    return (
        <div className={`mt-3 ${styles.mainContainer}`}>
            ...
            <div className={`flex justify-between ${styles.container}`}>
                ...
                <div className="flex">
                    <CustomButton buttonStyle={` ${styles.button}`} title="Deposit" handleButtonClick={() => { }} />
            ...
            <div className={`flex justify-between ${styles.container} `}>
                ...
                <div className={styles.rightContainer}>
                    <span className={styles.containerSubTitle}>{row.totalSupplyIchi}</span>
                    <span className={styles.containerSubTitle1}>{row.totalSupplyusd}</span>
                </div>
            </div>
            <div className={`flex justify-between ${styles.container} `}>
                <span className={styles.containerTitle}>Total Borrowed</span>
                <div className={styles.rightContainer}>
                    <span className={styles.containerSubTitle}>{row.totalBorrowedIchi}</span>
                    <span className={styles.containerSubTitle1}>{row.totalBorrowedUsd}</span>
                </div>
            </div>
            <div className={`flex justify-between ${styles.container} `}>
...
const MobileTableLend = ({ tableData }: any) => {
    return (
